...
#    Updated: 2021/07/02 13:02:55 by atable           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = webserv

SRC = Server/Server.cpp Server/Serv.cpp Request/Response.cpp Request/Request.cpp main.cpp utils/utils.cpp utils/CGI.cpp
